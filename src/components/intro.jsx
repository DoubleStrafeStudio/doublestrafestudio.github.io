...
export function Intro () {
    return(
        <div className='intro-statement heading-text'>
            ...
            <br />
            I'm a former environmental consultant with a chemical engineering background. If there's a way I can combine my developer knowledge to serve your environmental needs, that would be amazing. 
